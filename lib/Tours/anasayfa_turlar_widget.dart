...
import 'package:selamet/Tours/service/tour_filter_service.dart';
import 'package:selamet/Tours/View/filter_widget.dart';
...
class _AnasayfaTurlarWidgetState extends State<AnasayfaTurlarWidget> {
  ...
  Widget build(BuildContext context) {
    final turlarRef =
        FirebaseFirestore.instance.collection(widget.serviceTitle);
